...
# make a temporary xml file from template (ARCGIS_METADATA_TEMPLATE.xml)
#   by pulling data from oracle metadata table
...
for survey_short in survey_names:
  ...
  # maybe check that there is only one layerID, if not break?
