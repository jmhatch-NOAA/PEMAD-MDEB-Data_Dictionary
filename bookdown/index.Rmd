...
# rename files
rmd = c('survey_mitigation.Rmd', 'clam_quahog.Rmd', 'edna.Rmd', 'hook_line.Rmd', 'gombll.Rmd', 'scallop.Rmd', 'csbll.Rmd', 'bottom_trawl.Rmd', 'shrimp.Rmd', 'coastspan.Rmd', 'ecomon.Rmd', 'seal.Rmd', 'narw.Rmd', 'mmst.Rmd', 'pam.Rmd', 'turtle.Rmd', 'smit_sop.Rmd', 'data_hub.Rmd', 'examples.Rmd')
