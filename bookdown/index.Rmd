...
# rename files
rmd = c('survey_mitigation.Rmd', 'ecomon.Rmd', 'csbll.Rmd', 'coastspan.Rmd', 'seal.Rmd', 'turtle.Rmd', 'clam_quahog.Rmd', 'scallop.Rmd', 'shrimp.Rmd', 'hook_line.Rmd', 'bottom_trawl.Rmd', 'mmst.Rmd', 'narw.Rmd', 'gombll.Rmd', 'edna.Rmd', 'pam.Rmd', 'smit_sop.Rmd', 'data_hub.Rmd', 'examples.Rmd')
