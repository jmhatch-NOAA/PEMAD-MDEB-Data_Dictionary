---
title: "MDEB_SPATIAL <br> Data Dictionary"
author:
  - Joshua Hatch
  - Nicole Mucci
date: '`r Sys.Date()`'
...
This data dictionary is meant to catalog and communicate the structure and content of the MDEB_SPATIAL, and provide meaningful descriptions of the data objects for users.
