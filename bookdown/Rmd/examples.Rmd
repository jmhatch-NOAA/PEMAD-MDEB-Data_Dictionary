...
First, obtain the REST URL for the desired feature service from ArcGIS Online. You can obtain this REST URL from the [MDEB GIS Data Hub](https://mdeb-nefsc-noaa.hub.arcgis.com/) using either the [Content library](https://mdeb-nefsc-noaa.hub.arcgis.com/search) or the Content gallery. We will use the Content gallery in this example. First, scroll through the gallery and find the feature service that you are interested in. Click on 'View item details' to be taken to the feature service landing page.
